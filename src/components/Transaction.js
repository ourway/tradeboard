...
const styles = {
  container: { borderRadius: "3px", background: "#f0f0f0", padding: "10px" },
  utxo: {
    borderRadius: "3px",
    background: "#fff",
    padding: "10px",
  ...
  utxoContainer: { width: "45%", overflow: "hidden", display: "inline-block" },
  transactionContent: { justifyContent: "space-between", display: "flex" },
  confirmations: {
    borderRadius: "3px",
    background: "#45EDAA",
    color: "#fff",
...
const Utxo = ({ utxo }) => (
  <div style={styles.utxo}>
    <p style={{ margin: "0px", color: "#2CBFC7", display: "inline-block" }}>
      {utxo.addr.substring(0, 30)}...
    </p>
