...
class Block extends Component {
  ...
  getBlock(hash) {
    fetch(`http://144.202.29.48:32123/block_by_hash/${hash}`)
      ...
      .then(block =>
        this.setState({ block }, () =>
          fetch(`http://144.202.29.48:32123/latest_block`)
            .then(d => d.json())
    ...
    return (
      ...
      >
        <span style={{ fontSize: "24px", fontWeight: "bold" }}>
          ...
          <h1 style={{ fontSize: "24px", display: "inline-block" }}>
            Block #{block.index}
          </h1>
        </span>
        ...
        <div style={styles.summaryContainer}>
          <div style={{ width: "48%", display: "inline-block", float: "left" }}>
            ...
            >
              ...
              <p style={styles.text}>
                {block.transactions[0].outputs[0].amount} XEX
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              <p style={styles.text}>
                {moment.unix(block.timestamp).format("MMM DD, YYYY hh:mm:ss A")}
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              <p style={styles.text}>
                <ColorHash hash={block.merkle_root} />
              </p>
            </div>
          </div>
          <div style={{ width: "48%", display: "inline-block", float: "left" }}>
            ...
            >
              ...
              <Link
                style={styles.text}
                to={`/blockexplorer/block/${block.previous_hash}`}
              >
                <ColorHash hash={block.previous_hash} />
              </Link>
            </div>
            <div
              style={{
